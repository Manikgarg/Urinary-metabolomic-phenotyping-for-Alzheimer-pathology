...
met_matrix_name <-paste("/hps/nobackup/ma/natalja/data/mQTL_data/met_matrices/EigenMS_QN_removed_cohort/",base,diagnosis,".tsv",sep="")
cov_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/covariates/Covariates_",base,diagnosis,".txt",sep="") 
output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/EigenMS_QN_removed_cohort/mqtl_",base,diagnosis,".txt",sep="") 
...
permuted_output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/EigenMS_QN_removed_cohort/mqtl_permuted_",base,diagnosis,".txt",sep="") 
...
if (nrow(res_permuted[res_permuted$FDR<0.01,])==0){
    ...
    write.table(res,paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/EigenMS_QN_removed_cohort/result_",base,diagnosis,"_annot.txt",sep="") ,sep="\t",row.names = FALSE)
    write.table(res_annot,paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/EigenMS_QN_removed_cohort/result_",base,diagnosis,"_annot_full.txt",sep=""),sep="\t",row.names = FALSE)
}
