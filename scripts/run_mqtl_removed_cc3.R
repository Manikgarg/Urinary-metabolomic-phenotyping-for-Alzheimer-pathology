...
output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/normalization_final/mqtl2_",base,diagnosis,".txt",sep="") 
...
permuted_output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/normalization_final/mqtl2_permuted_",base,diagnosis,".txt",sep="") 
...
if (nrow(res_permuted[res_permuted$FDR<0.01,])==0){
    ...
    write.table(res,paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/normalization_final/result2_",base,diagnosis,"_annot.txt",sep="") ,sep="\t",row.names = FALSE)
    write.table(res_annot,paste("/hps/nobackup/ma/natalja/data/mQTL_data/results/normalization_final/result2_",base,diagnosis,"_annot_full.txt",sep=""),sep="\t",row.names = FALSE)
}
