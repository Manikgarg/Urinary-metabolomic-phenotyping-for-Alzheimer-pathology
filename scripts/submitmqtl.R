...
output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/NMR_Results/mqtl_",base,".txt",sep="") 
...
permuted_output_file_name <- paste("/hps/nobackup/ma/natalja/data/mQTL_data/NMR_Results/mqtl_permuted_",base,".txt",sep="") 
...
if (nrow(res_permuted[res_permuted$FDR<0.01,])==0){
    ...
    write.table(res,paste("/hps/nobackup/ma/natalja/data/mQTL_data/NMR_Results/result_",base,"_annot.txt",sep="") ,sep="\t",row.names = FALSE)
    write.table(res_annot,paste("/hps/nobackup/ma/natalja/data/mQTL_data/NMR_Results/result_",base,"_annot_full.txt",sep=""),sep="\t",row.names = FALSE)
}
