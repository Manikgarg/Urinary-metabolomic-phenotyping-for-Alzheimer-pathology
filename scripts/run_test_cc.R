...
#mQTL Analysis
me <- mqtl_analysis(snps,met_matrix_name,cov_name,output_file_name)
saveRDS(me, paste("/hps/nobackup/ma/natalja/data/mQTL_data/",base,".rds",sep=""))
...
mep <- mqtl_analysis(snps,permuted_met_matrix_name,cov_name,permuted_output_file_name)
saveRDS(mep, paste("/hps/nobackup/ma/natalja/data/mQTL_data/",base,"_permuted.rds",sep=""))
